...
;nop
call tiempolargo ;llamar a la rutina de tiempo
...
;nop ;NOPs de relleno (ajuste de tiempo)
return
 ;goto largo ;regresar y repetir
;rutina de tiempo
tiempolargo:
;nop
movlw d'154' ;establecer valor de la variable m
movwf m
mlooplargo:
nop
decfsz m,f
...
;bcf PORTB,0 ;poner el puerto B0 (bit 0 del puerto B) en 0
;nop
call tiempocorto ;llamar a la rutina de tiempo
;nop ;NOPs de relleno (ajuste de tiempo)
;nop
;nop 
;nop
