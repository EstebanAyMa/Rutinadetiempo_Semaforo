...
;rutina de tiempo
tiempo:
movlw d'66' ;establecer valor de la variable m
movwf m
mloop:
nop
decfsz m,f
goto mloop
 ...
 movlw d'41' ;establecer valor de la variable i
movwf i
iloop:
nop ;NOPs de relleno (ajuste de tiempo)
movlw d'21' ;establecer valor de la variable j
movwf j
jloop:
;nop ;NOPs de relleno (ajuste de tiempo)
movlw d'79' ;establecer valor de la variable k
movwf k
kloop:
nop
decfsz k,f
